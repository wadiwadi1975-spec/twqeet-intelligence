  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <KPICard title="إجمالي الأرباح" value={summary?.totalProfit?.toLocaleString() || '0'} subtitle="دينار كويتي" color="green" trend={summary?.profitGrowth?.startsWith('+') ? 'up' : 'down'} trendValue={summary?.profitGrowth || '+0%'}
